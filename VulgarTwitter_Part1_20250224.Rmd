---
title: "F%$# Twitter. A corpus-based analysis of vulgar language on Twitter - Part 1: data preparation"
author: "Anonymous"
...
This document shows an analysis that was performed with the aim of analysign vulgarity on Twitter. 
...
```{r eval = F}
# list files
fls <- list.files("C:/Users/Martin/OneDrive/Dokumente/Corpora/CorporaHDD/GloWbE", 
                  pattern = "txt", 
                  full.names = T, 
                  recursive = T, 
                  include.dirs = T)
...
patterns <- c(
  ...
  # "butt"
  "\\b[b8ß3][uµüúû][t7+†][t7+†][sz]*(whipe|hole|h)*[hl]*[sz]*\\b",
  ...
  "\\b(cluster|head|mother|motha|mutha|mada|cock|mom|mum|daddy|father|sister|brother)*[f=ƒ][uµüúû|@a4äáå|e3€ëéê|o0øöóõ|*]*[c¢©(]*[k|<{(][e3€ëéê]*[r]*(face|ing|er|a|ed|ers|az)*\\b",
